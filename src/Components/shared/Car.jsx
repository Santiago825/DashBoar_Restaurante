...
export default function Card(props) {
  ...
  return (
    <div
      className={` lg:col-span-2 bg-[#1F1D2B] fixed top-0 lg:right-0 lg:w-48  w-full h-full transition-all z-50 ${
        showOrder ? "right-0" : "-right-full"
      } `}
    >
      {/* orders */}
      <div className="relative pt-16 lg:pt-8 h-full text-gray-300 p-8  ">
        <RiCloseLine
        ...
        <div className="flex items-center gap-4 flex-wrap mb-8">
          ...
          <button className="bg-[#1F1D2B]  text-[#ec7c6a] py-2 px-4 rounded-xl border border-gray-500 ">
            To Go
          </button>
          <button className="bg-[#1F1D2B]  text-[#ec7c6a] py-2 px-4 rounded-xl border border-gray-500  ">
            Delivery
        ...
        {/* submit payment */}
        <div className="bg-[#262837] w-full absolute bottom-0 p-4 left-0 text-gray-300">
          <div className="flex items-center justify-between mb-4">
            <span className="text-gray-400">Discount</span>
            <span>$0</span>
          </div>
